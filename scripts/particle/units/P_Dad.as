package particle.units
{
   ...
   public class P_Dad extends P_Unit
   {
       
      
      public function P_Dad(layerNo:int, data:DO_UnitData)
      {
         super(layerNo,data);
      }
      ...
      override public function create() : void
      {
         ...
         _hpMax = 30;
         _hitPoint = 30;
         _deathVoiceID = GameVoice.WALTER_DIE;
         _hitVoiceID = GameVoice.WALTER_HIT;
         _jumpVoiceID = GameVoice.WALTER_JUMP;
         _selectVoiceID = GameVoice.WALTER_SELECT;
         _victoryVoiceID = GameVoice.WALTER_VICTORY;
      }
      ...
      override public function update() : void
      {
         ...
         super.update();
         if(GM.ins.cl.isTracking && GM.ins.cl.tracked is P_Mom)
         {
            this.updateMovement();
         }
      }
      ...
      override protected function updateMovement() : void
      {
         ...
         if(!_onLadder && !_isPulling)
         {
            ...
            if(_canJump == 0 && _isJumping == 0 && !_onAir && (KM.ins.isDown(KM.KEY_W) || KM.ins.isDown(KM.UP)))
            {
               this.jump();
            }
            if(_isJumping > 0)
