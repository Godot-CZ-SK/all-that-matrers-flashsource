   ...
   public class Slider extends Component
   {
      ...
      protected function onBackClick(event:MouseEvent) : void
      {
         if(this._orientation == HORIZONTAL)
         {
            ...
            this._value = Math.round(this._handle.x / (width - _height) * (this._max - this._min) + this._min);
         }
         else
         {
            ...
            this._value = Math.round((_height - _width - this._handle.y) / (height - _width) * (this._max - this._min) + this._min);
         }
