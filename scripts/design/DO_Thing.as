package design
{
   ...
   public class DO_Thing extends DesignObject
   {
      ...
      public function DO_Thing(parent:DisplayObjectContainer)
      {
         super(parent,GameCamera.THING);
         this._data = new DO_ThingData();
      }
      ...
      override public function drawProperties() : void
      {
         ...
         this._typeSlider.value = this._data.thingType;
      ...
      {
         this._data.thingType = this._typeSlider.value;
         this.removeFakeCostume();
         this.drawFakeCostume();
      }
      ...
      {
         this._data = newData as DO_ThingData;
         this.drawRealCostume();
      }
   }
}
