package design
{
   ...
   public class DO_Bouncer extends DesignObject
   {
      ...
      protected var _drawBody:MC_DO_BouncerFake;
      
      protected var _scaleSlider:HUISlider;
      
      protected var _powerSlider:HUISlider;
      
      public function DO_Bouncer(parent:DisplayObjectContainer)
      {
         super(parent,GameCamera.BOUNCER);
         this._data = new DO_BouncerData();
      }
      ...
      override public function drawFakeCostume() : void
      {
         ...
         this._drawBody = new MC_DO_BouncerFake();
      ...
      {
         _realCostume = new MC_DO_Bouncer();
      ...
      {
         this._data = newData as DO_BouncerData;
         this.drawRealCostume();
      }
   }
}
