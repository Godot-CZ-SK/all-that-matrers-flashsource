package design.data
{
   ...
   public class DO_DoorData extends DO_Data
   {
      ...
      public const SIZE_X:Number = 50;
      
      public const SIZE_Y:Number = 80;
      
      public function DO_DoorData()
      {
         super(TYPE_DOOR);
         this.scale = 1;
         this.min_scale = 0.5;
      ...
      {
         var result:DO_DoorData = new DO_DoorData();
         result.x = this.x;
         result.y = this.y;
