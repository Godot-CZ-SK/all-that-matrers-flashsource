package design
{
   ...
   public class DO_Button extends DesignObject
   {
      ...
      protected var _drawBody:MC_DO_ButtonFake;
      ...
      public function DO_Button(parent:DisplayObjectContainer)
      {
         this._data = new DO_ButtonData();
      ...
      private function rotChangeHandler(e:Event) : void
      {
         var rot:Number = this._rotationSlider.value;
         rot = Math.round(rot / 45) * 45;
         this._data.rotation = rot / 180 * Math.PI;
         this.drawUpdate();
      }
      ...
      override public function drawFakeCostume() : void
      {
         ...
         this._drawBody = new MC_DO_ButtonFake();
      ...
      protected function get data() : DO_ButtonData
      {
         return this._data;
      }
      
      protected function set data(data:DO_ButtonData) : void
      {
         this._data = data;
      }
      ...
      {
         this._data = newData as DO_ButtonData;
         this.drawRealCostume();
      }
   }
}
