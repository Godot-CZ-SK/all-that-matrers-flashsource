package design
{
   ...
   public class DO_PistonDoor extends DesignObject
   {
      ...
      public function DO_PistonDoor(parent:DisplayObjectContainer)
      {
         this._data = new DO_PistonDoorData();
         super(parent,GameCamera.DOOR);
      }
      ...
      {
         var rot:Number = int(this._rotationSlider.value / 45) * 45;
      ...
      override protected function drawUpdate() : void
      {
         ...
         DO_Data.drawRotatedRectangle(1,this._drawBody.graphics,this._data.x,this._data.y,this._data.TOTAL_WIDTH * this._data.scale,this._data.TOTAL_HEIGHT * this._data.scale,this._data.rotation * Math.PI / 180);
      ...
      {
         _realCostume = new MC_PistonDoor();
      ...
      protected function get data() : DO_PistonDoorData
      {
         return this._data;
      }
      
      protected function set data(data:DO_PistonDoorData) : void
      {
         this._data = data;
      }
      ...
      {
         this._data = newData as DO_PistonDoorData;
         this.drawRealCostume();
      }
   }
}
