package design
{
   ...
   public class DO_SlideDoor extends DesignObject
   {
      ...
      public function DO_SlideDoor(parent:DisplayObjectContainer)
      {
         this._data = new DO_SlideDoorData();
         super(parent,GameCamera.SLIDE_DOOR);
      }
      ...
      override protected function drawUpdate() : void
      {
         ...
         this._drawBody.graphics.drawRect(this.data.x - this.data.WIDTH / 2 * this.data.scale,this.data.y - this.data.HEIGHT / 2 * this.data.scale,this.data.WIDTH * this.data.scale,this.data.HEIGHT * this.data.scale);
      ...
      protected function get data() : DO_SlideDoorData
      {
         return this._data;
      }
      
      protected function set data(data:DO_SlideDoorData) : void
      {
         this._data = data;
      }
      ...
      {
         this._data = newData as DO_SlideDoorData;
         this.drawRealCostume();
      }
   }
}
