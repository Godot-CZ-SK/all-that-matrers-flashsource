package design
{
   ...
   public class DO_Door extends DesignObject
   {
      ...
      public function DO_Door(parent:DisplayObjectContainer)
      {
         this._data = new DO_DoorData();
      ...
      override protected function drawUpdate() : void
      {
         ...
         this._drawBody.graphics.drawRect(this.data.x - this.data.SIZE_X / 2 * this.data.scale,this.data.y - this.data.SIZE_Y / 2 * this.data.scale,this.data.SIZE_X * this.data.scale,this.data.SIZE_Y * this.data.scale);
      ...
      protected function get data() : DO_DoorData
      {
         return this._data;
      }
      
      protected function set data(data:DO_DoorData) : void
      {
         this._data = data;
      }
      ...
      {
         this._data = newData as DO_DoorData;
         this.drawRealCostume();
      }
   }
}
