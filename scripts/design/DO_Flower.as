package design
{
   ...
   public class DO_Flower extends DesignObject
   {
      ...
      protected var _backBox:CheckBox;
      
      public function DO_Flower(parent:DisplayObjectContainer)
      {
         super(parent,GameCamera.FLOWER_FRONT);
         this._data = new DO_FlowerData();
      }
      ...
      override public function completeDrawing() : void
      {
         ...
         if(this._data.back)
         {
            GameCamera.ins.changeChildrenLayer(_costume,GameCamera.FLOWER_BACK);
         }
         else
         {
            GameCamera.ins.changeChildrenLayer(_costume,GameCamera.FLOWER_FRONT);
         }
      ...
      override public function drawProperties() : void
      {
         ...
         _propCostume.graphics.drawRect(0,400,160,80);
         _propCostume.graphics.endFill();
         DM.ins.menu.addChild(_propCostume);
         this._backBox = new CheckBox(_propCostume,5,405,"Back?");
         this._backBox.selected = this._data.back;
         this._backBox.setSize(150,20);
         this._backBox.addEventListener(MouseEvent.CLICK,this.backClickHandler);
         ...
         this._typeSlider.maximum = 3;
         this._typeSlider.value = this._data.flowerType;
      ...
      {
         this._data.back = this._backBox.selected;
         if(this._data.back)
         {
            GameCamera.ins.changeChildrenLayer(_costume,GameCamera.FLOWER_BACK);
         }
      ...
      {
         this._data.flowerType = this._typeSlider.value;
         this.removeFakeCostume();
         this.drawFakeCostume();
      }
      ...
      {
         this._data = newData as DO_FlowerData;
         this.drawRealCostume();
      }
   }
}
