package design
{
   ...
   public class DO_Stone extends DesignObject
   {
      ...
      public function DO_Stone(parent:DisplayObjectContainer)
      {
         super(parent,GameCamera.STONE_FRONT);
         this._data = new DO_StoneData();
      }
      ...
      override public function drawProperties() : void
      {
         ...
         this._typeSlider.maximum = 4;
         this._typeSlider.value = this._data.stoneType;
      ...
      private function backClickHandler(e:MouseEvent) : void
      {
         ...
         if(this._data.back)
         {
            GameCamera.ins.changeChildrenLayer(_costume,GameCamera.STONE_BACK);
         }
         else
         {
            GameCamera.ins.changeChildrenLayer(_costume,GameCamera.STONE_FRONT);
         }
         this.drawUpdate();
      }
      ...
      {
         this._data.stoneType = this._typeSlider.value;
         this.removeFakeCostume();
         this.drawFakeCostume();
      }
      ...
      {
         this._data = newData as DO_StoneData;
         this.drawRealCostume();
      }
   }
}
