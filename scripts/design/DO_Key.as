package design
{
   ...
   public class DO_Key extends DesignObject
   {
      ...
      public function DO_Key(parent:DisplayObjectContainer)
      {
         this._data = new DO_KeyData();
         super(parent,GameCamera.KEY);
      }
      ...
      protected function get data() : DO_KeyData
      {
         return this._data;
      }
      
      protected function set data(data:DO_KeyData) : void
      {
         this._data = data;
      }
      ...
      {
         this._data = newData as DO_KeyData;
         this.drawRealCostume();
      }
   }
}
